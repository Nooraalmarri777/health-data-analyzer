...
if uploaded_file:
    try:
        ...
        if not numeric_columns:
            st.warning("No numeric columns found in the data for analysis.")
        else:
            columns = st.multiselect("Select columns for analysis", numeric_columns, default=numeric_columns)
            ...
            if "Trends" in analysis_type:
                ...
                time_col = st.selectbox("Select time-related column", df.columns.tolist())
